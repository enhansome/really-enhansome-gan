...
* Reproduction of the GANs paper (MNIST) in 100 lines of PyTorch code  [\[Blog\]](https://papers-100-lines.medium.com/generative-adversarial-networks-in-100-lines-of-code-516f09d1790a) [\[Code\]](https://github.com/MaximeVandegar/Papers-in-100-Lines-of-Code/tree/main/Generative_Adversarial_Networks) ⭐ 2,885 | 🐛 0 | 🌐 Python | 📅 2026-08-30
* Reproduction of results from the paper *Conditional Generative Adversarial Nets* in 100 lines of PyTorch code  [\[Code\]](https://github.com/MaximeVandegar/Papers-in-100-Lines-of-Code/tree/main/Conditional_Generative_Adversarial_Nets) ⭐ 2,885 | 🐛 0 | 🌐 Python | 📅 2026-08-30
* Reproduction of results from the paper *Improved Techniques for Training GANs* in 100 lines of PyTorch code  [\[Code\]](https://github.com/MaximeVandegar/Papers-in-100-Lines-of-Code/tree/main/Improved_Techniques_for_Training_GANs) ⭐ 2,885 | 🐛 0 | 🌐 Python | 📅 2026-08-30
* Reproduction of results from the *LSGAN* paper in 100 lines of PyTorch code  [\[Code\]](https://github.com/MaximeVandegar/Papers-in-100-Lines-of-Code/tree/main/Least_Squares_Generative_Adversarial_Networks) ⭐ 2,885 | 🐛 0 | 🌐 Python | 📅 2026-08-30
* Reproduction of results from the *WGAN* paper in 100 lines of PyTorch code  [\[Code\]](https://github.com/MaximeVandegar/Papers-in-100-Lines-of-Code/tree/main/Wasserstein_GAN) ⭐ 2,885 | 🐛 0 | 🌐 Python | 📅 2026-08-30
* Reproduction of results from the *pix2pix* paper in 100 lines of PyTorch code  [\[Code\]](https://github.com/MaximeVandegar/Papers-in-100-Lines-of-Code/tree/main/Image_to_Image_Translation_with_Conditional_Adversarial_Nets) ⭐ 2,885 | 🐛 0 | 🌐 Python | 📅 2026-08-30
...
* Wasserstein GAN [\[arXiv\]](https://arxiv.org/abs/1701.07875) [\[Code\]](https://github.com/martinarjovsky/WassersteinGAN) ⭐ 3,245 | 🐛 28 | 🌐 Python | 📅 2018-12-26 [\[Code\]](https://github.com/wiseodd/generative-models) ⭐ 7,490 | 🐛 30 | 🌐 Python | 📅 2024-03-24
...
* Generative Visual Manipulation on the Natural Image Manifold [\[Project\]](http://www.eecs.berkeley.edu/~junyanz/projects/gvm/) [\[Youtube\]](https://youtu.be/9c4z6YsBGQ0) [\[Paper\]](https://arxiv.org/abs/1609.03552) [\[Code\]](https://github.com/junyanz/iGAN) ⭐ 4,007 | 🐛 14 | 🌐 Python | 📅 2020-08-05
